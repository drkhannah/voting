...
**If you get this warning when editing a root component**, this may be because you don't export anything from it, and call `React.render` from there. Put your root component in a separate file (e.g. `App.jsx`) and `require` it from `index.jsx` where you call `React.render`.
...
#### I see “[WDS] Hot Module Replacement enabled” but nothing happens when I edit `App.jsx`

If you're running Node 0.11.13, you might want to try updating to 0.12. Some people reported this helped solve this problem. Also **make sure that your `require`s have the same filename casing as the files.** Having `App.jsx` and doing `require('app')` might trip the watcher on some systems.
...
#### I see “[HMR] Nothing hot updated.” and nothing happens when I edit `App.jsx`
